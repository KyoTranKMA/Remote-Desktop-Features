...
import VNCClient.client.rendering.ColorDepth;
import VNCClient.protocol.messages.MessageHeaderFlags;
...
import static VNCClient.client.rendering.ColorDepth.BPP_8_INDEXED;

public class VNCConfig {

    private Supplier<String> usernameSupplier;
    private Supplier<String> passwordSupplier;
    private Consumer<BaseVncException> errorListener;
    ...
    public Consumer<BaseVncException> getErrorListener() {
     ...
     */
    public void setErrorListener(Consumer<BaseVncException> errorListener) {
    ...
    /**
     * Enable or disable the clipboard support
     * @param enableClipBoard enable or disable the clipboard support
     */
    public void setEnableClipboardCopy(boolean enableClipBoard) { this.enableClipBoard = enableClipBoard; }
